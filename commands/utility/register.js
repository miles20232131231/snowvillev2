...
const logChannelId = '1288846529754300479'; // Replace with your channel ID
...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            // Check the registration limit based on the user's role
            const maxVehicles = interaction.member.roles.cache.has('1284792068543090749') ? 20 : 10;
            ...
            if (vehicleData.length >= maxVehicles) {
                return await interaction.editReply({
                    content: `You can only register up to ${maxVehicles} vehicles. You have already registered ${vehicleData.length}.`,
                    ephemeral: true
                });
            }
